...
bottomGround = createSprite(width,height-50,width,20);
bottomGround.visible = false;

topGround = createSprite(width/2,10,width,20);
...
obstacleTop.y = Math.round(random(10,height/2));
...
obstacleTop.lifetime = width/obstacleTop.velocityX;
  ...
  var r = Math.round(random(80,200))
   ...
   //generate random bottom obstacles
    ...
    obstacleBottom.scale = 0.17;
     //assign lifetime to the variable
   obstacleBottom.lifetime = width/obstacleBottom.velocityX;
